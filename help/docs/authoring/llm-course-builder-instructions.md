# Superable Learning LMS — Master LLM Course Builder Instructions

> **System Prompt & Technical Specifications**: Copy and paste the prompt below into any AI LLM (Gemini 1.5 Pro/Flash, ChatGPT-4o/o3-mini, Claude 3.5 Sonnet) to generate 100% WCAG 2.2 AA compliant e-learning course packages for Superable Learning LMS.
